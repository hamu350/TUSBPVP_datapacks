...
# Mobへ代入
    # Player
        ...
        execute if entity @s[type=player] if score @s ScoreToHealth matches ..0 at @s run scoreboard players add @a[tag=AttackPlayer,limit=1,sort=nearest] PreKillCount 1
