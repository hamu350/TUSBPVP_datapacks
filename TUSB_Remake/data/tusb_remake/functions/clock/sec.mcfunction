...
## 時間制限ボスバー
execute if data storage tusb_pvp: Settings{Battle:1b} if data storage tusb_pvp: Settings{time_limit:1b} store result bossbar tusb_pvp:time_limit value run scoreboard players get _ TimeLimit
execute if data storage tusb_pvp: Settings{Battle:1b} if data storage tusb_pvp: Settings{time_limit:1b} run scoreboard players remove _ TimeLimit 1