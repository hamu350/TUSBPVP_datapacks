...
execute unless data storage tusb_pvp: {Battle:1b} run tellraw @s ["",{"translate":"・バトルモード設定","bold":true,"clickEvent": {"action": "run_command","value": "/trigger ShowMenu set 10"}}," ",{"translate":"・職業変更","bold":true,"clickEvent":{"action":"run_command","value":"/trigger ShowMenu set 20"}}," ",{"translate": "・スキル変更","bold":true,"clickEvent": {"action": "run_command","value": "/trigger ShowMenu set 1"}},{"translate": "・ステージ変更","bold":true,"clickEvent": {"action": "run_command","value": "/trigger ShowMenu set 60"}}]
