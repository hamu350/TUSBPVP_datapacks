...
execute if data storage tusb_pvp: Settings{TimeLimit:1b} if score @s ShowMenu matches 312 run function tusb_remake:pvp/time_limit/3min
execute if data storage tusb_pvp: Settings{TimeLimit:1b} if score @s ShowMenu matches 313 run function tusb_remake:pvp/time_limit/5min
execute if data storage tusb_pvp: Settings{TimeLimit:1b} if score @s ShowMenu matches 314 run function tusb_remake:pvp/time_limit/7min
execute if data storage tusb_pvp: Settings{TimeLimit:1b} if score @s ShowMenu matches 315 run function tusb_remake:pvp/time_limit/10min
execute unless data storage tusb_pvp: Settings{TimeLimit:1b} if score @s ShowMenu matches 312..315 run function tusb_remake:pvp/time_limit/miss
