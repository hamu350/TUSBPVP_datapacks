...
execute as @e[distance=..8,tag=!This,type=!#tusb_remake:resist_ice,tag=Enemy,nbt=!{ActiveEffects:[{Id:23}]}] at @s unless score @s PlayerId = _ PlayerId run function tusb_remake:skill/black_mage/ice_storm/schedule/hit
