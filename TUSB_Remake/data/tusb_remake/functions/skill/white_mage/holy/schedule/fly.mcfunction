...
execute as @e[distance=..8,tag=!Owner,predicate=tusb_remake:player,nbt=!{ActiveEffects:[{Id:23}]}] at @s unless score @s PlayerId = _ PlayerId run function tusb_remake:skill/white_mage/holy/schedule/hit
