...
execute as @e[distance=..10,tag=!This,nbt=!{Invulnerable:true}] rotated as @s run tp @s ~ ~1 ~ ~6 ~
...
execute positioned ~-0.5 ~1 ~-0.5 as @e[dy=0,tag=!This,tag=Enemy,nbt=!{ActiveEffects:[{Id:23}]}] at @s run function tusb_remake:skill/summoner/summon_petit_black/black/hit
