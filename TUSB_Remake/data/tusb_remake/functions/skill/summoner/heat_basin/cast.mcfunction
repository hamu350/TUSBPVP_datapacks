...
execute as @e[distance=..15,tag=!This,predicate=tusb_remake:player] at @s anchored eyes positioned ^ ^ ^ anchored feet positioned ~ ~1.0 ~ run function tusb_remake:skill/summoner/heat_basin/summon
