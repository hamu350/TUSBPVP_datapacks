...
execute if score _ ActivatedSkill matches 6240 run execute positioned ^ ^ ^3 as @e[distance=..3,tag=!This,tag=Enemy] positioned ^ ^ ^-3 run function tusb_remake:skill/archer/blast_shot/hit/damage1
execute if score _ ActivatedSkill matches 6241..6249 run execute positioned ^ ^ ^3 as @e[distance=..3,tag=!This,tag=Enemy] positioned ^ ^ ^-3 run function tusb_remake:skill/archer/blast_shot/hit/damage2
