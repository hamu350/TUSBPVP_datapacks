...
### リメイク：HP少しアップ
summon minecraft:iron_golem ~ ~ ~ {CustomName:'"(ペット)ゴーレム"',CustomNameVisible:true,ArmorItems:[{id:"minecraft:iron_ingot",Count:1b,tag:{Enchantments:[{id:"minecraft:feather_falling",lvl:255s},{id:"minecraft:projectile_protection",lvl:10s}]}},{},{},{id:"minecraft:snowball",Count:1b}],ArmorDropChances:[-1E40f,-1E40f,-1E40f,-1E40f],Attributes:[{Name:"minecraft:generic.follow_range",Base:32d},{Name:"minecraft:generic.movement_speed",Base:0.32d},{Name:"generic.armor",Base:20d},{Name:"generic.armor_toughness",Base:8d},{Name:"minecraft:generic.knockback_resistance",Base:1d},{Name:"minecraft:generic.max_health",Base:20d}],Health:20f,PlayerCreated:false,DeathLootTable:"minecraft:empty",Tags:["PetGolem","Player","CooldownRequiredLong"],PortalCooldown:600}
...
tag @s add This
data modify entity @e[tag=GolemAEC,distance=0.01,limit=1,sort=nearest] AngryAt set from entity @p[tag=!This] UUID
tag @s remove This
