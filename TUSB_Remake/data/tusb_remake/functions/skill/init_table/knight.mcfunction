...
data modify storage tusb_remake: _.3 set value {name:["デコイ","デコイ"],level:[18,38],cost:10,description:[["周囲の敵を引き寄せる。"]]}
...
#剣士モード
data modify storage tusb_remake: _.20 set value {name:["流し斬り","流し斬り","流し斬り"],level:[3,20,37],cost:5,description:[["敵単体の攻撃力を低下させる。"]],condition:"剣で攻撃",duration:[20]}
data modify storage tusb_remake: _.21 set value {name:["薙ぎ払い","薙ぎ払い","薙ぎ払い"],level:[8,28,48],cost:10,description:[["周囲の敵を斬り上げる。"]],condition:"剣で攻撃",range:[5]}
data modify storage tusb_remake: _.22 set value {name:["真空斬り","真空斬り","真空斬り"],level:[13,26,39],cost:20,description:[["風の刃を発生させる。"]],condition:"剣を持って敵に向かってスニーク"}
...
data modify storage tusb_remake: _.24 set value {name:["魔神斬り","魔神斬り"],level:[23,46],cost:20,description:[["敵単体に大ダメージ。敵の武器を破壊することがある。","発動の反動で少しの間攻撃できなくなる。"]],condition:"剣で攻撃"}
