...
#剣士サポート
data modify storage tusb_remake: _.0 set value {name:["ファランクス","ファランクス","ファランクス","ファランクス"],level:[1,15,30,45],cost:20,description:[["自身の防御力を僅かに上昇させる。"]],duration:[60],sneak:{description:[["範囲内のプレイヤーの防御力を僅かに上昇させる。"]],range:[15]}}
data modify storage tusb_remake: _.1 set value {name:["アイアンウィル","アイアンウィル"],level:[5,35],cost:20,description:[["次のノックバックを軽減する。一定確率で効果が継続する。装備：継続確率にボーナス。"]]}
data modify storage tusb_remake: _.2 set value {name:["ストライ","ストライ","ストライ"],level:[10,25,40],cost:15,description:[["自身の攻撃力を上昇させる。"]],sneak:{description:[["自身の攻撃力を上昇させる。"]],range:[15]}}
data modify storage tusb_remake: _.3 set value {name:["デコイ","デコイ"],level:[18,38],cost:40,description:[["周囲の敵を引き寄せる。"]]}
data modify storage tusb_remake: _.4 set value {name:["タクティカルヒール"],level:[43],cost:30,description:[["次に大ダメージを受けた時、HPを大きく回復する。。"]]}
...
#剣士モード
data modify storage tusb_remake: _.20 set value {name:["流し斬り","流し斬り","流し斬り"],level:[3,20,37],cost:15,description:[["敵単体の攻撃力を低下させる。"]],condition:"剣で攻撃",duration:[20]}
data modify storage tusb_remake: _.21 set value {name:["薙ぎ払い","薙ぎ払い","薙ぎ払い"],level:[8,28,48],cost:20,description:[["周囲の敵を斬り上げる。"]],condition:"剣で攻撃",range:[5]}
data modify storage tusb_remake: _.22 set value {name:["真空斬り","真空斬り","真空斬り"],level:[13,26,39],cost:10,description:[["風の刃を発生させる。"]],condition:"剣を持って敵に向かってスニーク"}
data modify storage tusb_remake: _.23 set value {name:["リアクティブヒール","リアクティブヒール","リアクティブヒール"],level:[17,33,49],cost:10,description:[["被ダメージ時、HPが回復する。"]],condition:"被ダメージ"}
data modify storage tusb_remake: _.24 set value {name:["魔神斬り","魔神斬り"],level:[23,46],cost:40,description:[["敵単体に大ダメージ。敵の武器を破壊することがある。","発動の反動で少しの間攻撃できなくなる。"]],condition:"剣で攻撃"}
