...
#剣士サポート
data modify storage tusb_remake: _.0 set value {name:["ファランクス","ファランクス","ファランクス","ファランクス"],level:[1,15,30,45],cost:20,description:[["自身に耐性Ⅰを30秒間付与する。"]],duration:[60],sneak:{description:[["範囲内の味方に耐性Ⅰを30秒間付与する。"]],range:[15]}}
...
data modify storage tusb_remake: _.23 set value {name:["リアクティブヒール","リアクティブヒール","リアクティブヒール"],level:[17,33,49],cost:10,description:[["被ダメージ時、HPが4回復する。"]],condition:"被ダメージ"}
