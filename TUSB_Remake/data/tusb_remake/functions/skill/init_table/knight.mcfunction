...
data modify storage tusb_remake: _.4 set value {name:["タクティカルヒール"],level:[43],cost:30,description:[["次に12以上のダメージを受けた時、HPを12回復する。"]]}
...
data modify storage tusb_remake: _.24 set value {name:["魔神斬り","魔神斬り"],level:[23,46],cost:40,description:[["敵単体に40ダメージ。敵の武器を1/3の確率で破壊する。","発動の反動で弱体化100を2秒間受ける。"]],condition:"剣で攻撃"}
data modify storage tusb_remake: _.25 set value {name:["斬鉄剣"],level:[50],cost:100,description:[["範囲内の敵に50ダメージ。"]],condition:"剣で攻撃",range:[10]}
