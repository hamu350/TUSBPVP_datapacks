...
#剣士サポート
data modify storage tusb_remake: _.0 set value {name:["ファランクス","ファランクス","ファランクス","ファランクス"],level:[1,15,30,45],cost:20,description:[["自身に耐性Ⅱを30秒間付与する。"]],duration:[60],sneak:{description:[["範囲内の味方に耐性Ⅲを30秒間付与する。"]],range:[15]}}
...
data modify storage tusb_remake: _.2 set value {name:["ストライ","ストライ","ストライ"],level:[10,25,40],cost:15,description:[["自身に攻撃力上昇Ⅱを30秒間付与する。"]],sneak:{description:[["範囲内の味方に攻撃力上昇Ⅱを30秒間付与する。"]],range:[15]}}
data modify storage tusb_remake: _.3 set value {name:[""],level:[18,38],cost:30,description:[["範囲内の敵を引き寄せる。"]],range:[16]}
...
data modify storage tusb_remake: _.21 set value {name:["薙ぎ払い","薙ぎ払い","薙ぎ払い"],level:[8,28,48],cost:20,description:[["範囲内の敵を上に6m飛ばし、","着地時に追加で10ダメージ与える。"]],condition:"剣で攻撃",range:[5]}
...
data modify storage tusb_remake: _.23 set value {name:["リアクティブヒール","リアクティブヒール","リアクティブヒール"],level:[17,33,49],cost:10,description:[["被ダメージ時、HPが6回復する。"]],condition:"被ダメージ"}
data modify storage tusb_remake: _.24 set value {name:["魔神斬り","魔神斬り"],level:[23,46],cost:30,description:[["敵単体に30ダメージ。","発動の反動で弱体化100を2秒間受ける。"]],condition:"剣で攻撃"}
