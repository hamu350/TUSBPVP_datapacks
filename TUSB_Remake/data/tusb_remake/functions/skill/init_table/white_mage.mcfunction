...
data modify storage tusb_remake: _.1 set value {name:["ハートブースト","ハートブースト","ハートブースト","ハートブースト","ハートブースト"],level:[8,18,28,38,48],cost:40,description:[["範囲内の味方に衝撃吸収Ⅴを3分間付与する。"]],range:[15],duration:[180]}
...
data modify storage tusb_remake: _.22 set value {name:["フラワーギフト","フラワーギフト","フラワーギフト"],level:[15,30,45],cost:100,description:[["範囲内の敵のオフハンドを花に置き換える魔法を放つ。"]],condition:"雪玉を投げる",range:[5]}
