...
data modify storage tusb_remake: _.2 set value {name:["リジェネレーション","リジェネレーション","リジェネレーション"],level:[17,37,46],cost:40,description:[["範囲内の味方に再生能力Ⅱを60秒間付与する。"]],range:[15],duration:[90]}
