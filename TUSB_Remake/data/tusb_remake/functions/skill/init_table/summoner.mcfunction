...
data modify storage tusb_remake: _.23 set value {name:["ぽんぽんα","ぽんぽん"],level:[15,35],cost:10,description:[["周囲のペットを回復する。"]],condition:"ニンジン付きの棒を持って右クリック",range:[15]}
data modify storage tusb_remake: _.24 set value {name:["つんつんα","つんつん"],level:[18,38],cost:10,description:[["ペットに命令する。","ニンジン付き：支援しろ！","歪んだキノコ付き：技を使え！"]],condition:"〇〇付きの棒を持って右クリック",range:[15]}
