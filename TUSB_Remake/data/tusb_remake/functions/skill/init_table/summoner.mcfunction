...
data modify storage tusb_remake: _.30 set value {name:["サモン:ぷちブラック"],level:[50],cost:100,description:[["ぷちブラックホールを召喚する。","範囲内のプレイヤーとペットを全て吸い込み、敵には0.5秒ごとに13ダメージ与える。"]],condition:"ニンジン付きの棒を持って右クリック",duration:[15],range:[10]}
