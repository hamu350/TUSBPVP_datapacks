...
data modify storage tusb_remake: _.0 set value {name:["ルカナントラップ","ルカナントラップ","ルカナントラップ"],level:[3,23,43],cost:25,description:[["被ダメージを2倍にする罠を設置する。"]],range:[5],duration:[20]}
...
data modify storage tusb_remake: _.2 set value {name:["ボミオストラップ","ボミオストラップ"],level:[13,33],cost:25,description:[["移動速度低下Ⅵを付与する罠を設置する。"]],range:[5],duration:[20]}
data modify storage tusb_remake: _.3 set value {name:[""],level:[15],cost:10000,description:[["手持ちの食材を焼く。"]]}
data modify storage tusb_remake: _.4 set value {name:["エンチェイス","エンチェイス"],level:[17,37],cost:10,description:[["自身の次に放つ矢が8m以内の敵に当たるようになる。"]],sneak:{description:[["範囲内の味方の次に放つ矢が8m以内の敵に当たるようになる。"]],range:[15]}}
...
data modify storage tusb_remake: _.20 set value {name:["ステークスファイア","ステークスファイア","ステークスファイア"],level:[1,20,40],cost:15,description:[["矢の威力が70%で2倍になる。外れると0倍になる。"]],condition:"利き手で弓を構え矢を放つ"}
data modify storage tusb_remake: _.21 set value {name:["","",""],level:[8,28,48],cost:15,description:[["ダメージが周囲に広がる特殊な矢を放つ。"]],condition:"利き手で弓を構え矢を放つ",range:[5,15,25]}
...
data modify storage tusb_remake: _.23 set value {name:["ブラストショット","ブラストショット"],level:[25,45],cost:30,description:[["爆発する特殊な矢を放つ。爆発すると範囲内の敵に20ダメージ与える。"]],condition:"利き手で弓を構え矢を放つ",range:[6]}
data modify storage tusb_remake: _.24 set value {name:["バードストライク"],level:[26],cost:20,description:[["範囲内の敵に浮遊-125とジャンプ不可を5秒間付与する矢を放つ。"]],condition:"利き手で弓を構え矢を放つ",range:[6]}
...
data modify storage tusb_remake: _.26 set value {name:["フェイタルショット"],level:[50],cost:140,description:[["矢が着弾した時、範囲内の敵に以下の効果を与える。","・被ダメージ2倍","・移動速度低下20","・弱体化20","・浮遊-125","・ジャンプ不可","・攻撃力上昇解除","・火炎耐性解除","・水中呼吸解除"]],condition:"利き手で弓を構え矢を放つ",range:[10],duration:[10]}
