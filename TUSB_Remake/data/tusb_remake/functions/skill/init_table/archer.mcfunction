...
data modify storage tusb_remake: _.0 set value {name:["ルカナントラップ","ルカナントラップ","ルカナントラップ"],level:[3,23,43],cost:20,description:[["防御力を下げる罠を設置する。"]],range:[5],duration:[20]}
...
data modify storage tusb_remake: _.2 set value {name:["ボミオストラップ","ボミオストラップ"],level:[13,33],cost:20,description:[["移動速度を下げる罠を設置する。"]],range:[5],duration:[20]}
...
data modify storage tusb_remake: _.20 set value {name:["ステークスファイア","ステークスファイア","ステークスファイア"],level:[1,20,40],cost:7,description:[["矢の威力が10倍か0倍になる。"]],condition:"利き手で弓を構え矢を放つ"}
...
data modify storage tusb_remake: _.23 set value {name:["ブラストショット","ブラストショット"],level:[25,45],cost:5,description:[["爆発する特殊な矢を放つ。"]],condition:"利き手で弓を構え矢を放つ"}
...
data modify storage tusb_remake: _.25 set value {name:["ガストキャノン","ガストキャノン"],level:[39,49],cost:7,description:[["放った矢を火球に変える。"]],condition:"利き手で弓を構え矢を放つ"}
