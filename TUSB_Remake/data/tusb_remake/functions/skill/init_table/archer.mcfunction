...
data modify storage tusb_remake: _.0 set value {name:["ルカナントラップ","ルカナントラップ","ルカナントラップ"],level:[3,23,43],cost:30,description:[["被ダメージを2倍にする罠を設置する。"]],range:[5],duration:[20]}
...
data modify storage tusb_remake: _.2 set value {name:["ボミオストラップ","ボミオストラップ"],level:[13,33],cost:30,description:[["移動速度低下Ⅵを付与する罠を設置する。"]],range:[5],duration:[20]}
...
data modify storage tusb_remake: _.20 set value {name:["ステークスファイア","ステークスファイア","ステークスファイア"],level:[1,20,40],cost:10,description:[["矢の威力が70%で3倍になる。外れると0倍になる。"]],condition:"利き手で弓を構え矢を放つ"}
...
data modify storage tusb_remake: _.26 set value {name:["フェイタルショット"],level:[50],cost:160,description:[["矢が着弾した時、範囲内の敵に以下の効果を与える。","・被ダメージ2倍","・移動速度低下20","・弱体化20","・浮遊-125","・ジャンプ不可","・攻撃力上昇解除","・火炎耐性解除","・水中呼吸解除"]],condition:"利き手で弓を構え矢を放つ",range:[10],duration:[10]}
