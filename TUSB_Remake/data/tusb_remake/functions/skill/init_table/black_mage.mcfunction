...
data modify storage tusb_remake: _.4 set value {name:["マナリフレッシュ","マナリフレッシュ"],level:[23,43],cost:40,description:[["自身のMP自然回復量を1分間倍増する。"]],duration:[30],sneak:{description:[["範囲内の味方のMP自然回復量を1分間倍増する。"]],range:[15]}}
