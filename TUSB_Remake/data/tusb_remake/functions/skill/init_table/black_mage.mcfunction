...
data modify storage tusb_remake: _.22 set value {name:["サンダーボルト","サンダーボルト","サンダーボルト"],level:[10,30,48],cost:30,description:[["付近の敵単体に雷を落とし、25ダメージ与える。","水中または雨に当たりながら放つと範囲内全ての敵に30ダメージ与える。"]],condition:"ニンジン付きの棒を持って右クリック",range:[5]}
