...
data modify storage tusb_remake: _.1 set value {name:["疾風","疾風","疾風"],level:[8,23,38],cost:10,description:[["自身に移動速度上昇11を5秒間付与する。"]],duration:[60]}
...
data modify storage tusb_remake: _.21 set value {name:["連舞","連舞","連舞"],level:[5,25,45],cost:3,description:[["連続ヒット数に応じて以下のように攻撃力が上昇する。","§c§l1HIT §9攻撃力 +2§f,§9+30% 攻撃力","§c§l2HIT §9攻撃力 +4§f,§9+60% 攻撃力","§c§l3HIT §9攻撃力 +6§f,§9+90% 攻撃力","§c§l4HIT §9攻撃力 +8§f,§9+120% 攻撃力","§c§l5HIT §9攻撃力 +10§f,§9+150% 攻撃力"]],condition:"敵を攻撃",duration:[2]}
data modify storage tusb_remake: _.22 set value {name:["跳躍","跳躍","跳躍"],level:[13,26,39],cost:3,description:[["スニーク時間に応じて跳躍力が上昇する。","ジャンプ時、範囲内の敵に5ダメージ与える。"]],condition:"スニークする",duration:[3],range:[3]}
