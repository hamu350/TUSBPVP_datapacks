...
data modify storage tusb_remake: _.21 set value {name:["連舞","連舞","連舞"],level:[5,25,45],cost:3,description:[["連続ヒット数に応じて攻撃力が上昇する。"]],condition:"敵を攻撃",duration:[2]}
data modify storage tusb_remake: _.22 set value {name:["跳躍","跳躍","跳躍"],level:[13,26,39],cost:3,description:[["スニーク時間に応じて跳躍力が上昇する。"]],condition:"スニークする",duration:[3]}
data modify storage tusb_remake: _.23 set value {name:["居縮","居縮"],level:[28,46],cost:10,description:[["敵単体をすくみ上がらせ、金縛り状態にする。"]],condition:"雪玉を投げる",duration:[5]}
