...
### ついでに観光モードの看板も更新する
data merge block -2718 90 -393 {Text1:'{"text":"観光ﾓｰﾄﾞを切替えます","color":"dark_red","bold":true,"clickEvent":{"action":"run_command","value":"/function tusb_remake:system/switch_sightseeing_on"}}',Text2:'{"text":"観光モード中は","color":"dark_red","bold":true}',Text3:'{"text":"スペクテイター","color":"dark_red","bold":true}',Text4:'{"text":"になります","color":"dark_red","bold":true}'}
