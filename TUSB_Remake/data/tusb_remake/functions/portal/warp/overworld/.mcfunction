...
### タワーバンク行きかえり
execute positioned -2738 89 -375 align xyz if entity @s[dx=0] if entity @s[advancements={tusb_remake:press={tower_bank=false}}] run function tusb_remake:pvp/tower_bank_tp
execute positioned -2738 89 -375 align xyz if entity @s[dx=0] run advancement grant @s only tusb_remake:press tower_bank
execute positioned -2818 107 -406 align xyz if entity @s[dz=1] if entity @s[advancements={tusb_remake:press={tower_bank_exit=false}}] run tp @s -2724.0 88 -382.0
execute positioned -2818 107 -406 align xyz if entity @s[dz=1] run advancement grant @s only tusb_remake:press tower_bank_exit
